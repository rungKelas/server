...
route.post("/register/:TeacherId", StudentController.register)
...
route.get("/students/:TeacherId", StudentController.getAllStudents)
route.get("/student/scores/:StudentId", StudentController.totalQuestion)
